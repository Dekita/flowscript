...
// Colors based on Unreal Engine Blueprint pin types
export const pinTypeColors = {
    exec: 'var(--dek-text-color)',
    number: 'var(--dek-primary-normal)',
    string: 'var(--dek-secondary-normal)',
    boolean: 'var(--dek-info-normal)',
    object: 'var(--dek-warning-normal)',
