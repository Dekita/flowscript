...
export default function AutoUpdater({}) {
    ...
    return <React.Fragment>
        {showUpdateMessage && <div className='container text-center'>
            {updateMessage && <div className='text-white alert alert-danger border-2 border-danger2 py-1 px-3 mt-1'>
                <small><strong>{updateMessage}</strong></small>
            </div>}
            {canInstallUpdate && <button className='btn btn-sm btn-info mt-1 px-3' onClick={beginInstallUpdate}>
